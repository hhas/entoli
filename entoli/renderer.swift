...
// TO DO: how practical to implement renderer in entoli code? (this'd have benefit of being customizable, which could be useful when integrating into editor as it allows users to customize display themselves) (note: may be case of bootstrapping in Swift, then replacing with entoli implementation later)
